...
class Game:
    ...
    def standard():
        ...
        g.__board.set_figure(King(), Position(0, 3))
        g.__board.set_figure(Queen(), Position(0, 4))
        ...
        g.__board.set_figure(King(white=False), Position(7, 3))
        g.__board.set_figure(Queen(white=False), Position(7, 4))
    ...
    def print(self):
        ...
        return (
            f"Раунд: {self.__round}\n{self.__board.print(border=True)}\nХод {turn_str}:"
        )
