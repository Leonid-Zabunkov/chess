...
figure_factories = {
    ...
    "r": lambda: Figure.create("Rook", white=True),
    "R": lambda: Figure.create("Rook", white=False),
    "b": lambda: Figure.create("Bishop", white=True),
    "B": lambda: Figure.create("Bishop", white=False),
    "n": lambda: Figure.create("Knight", white=True),
    "N": lambda: Figure.create("Knight", white=False),
    "p": lambda: Figure.create("Pawn", white=True),
    "P": lambda: Figure.create("Pawn", white=False),
}
